<%-- 
    ...
    Created on : 17 Oct, 2018, 6:28:13 AM
    Author     : MIhir
--%>

<%-- 
    Document   : login1
    Created on : 2 Sep, 2018, 7:38:51 PM
    Author     : Mandar
--%>
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="css/adminemployee.css">
				        ...
				        <div class="form-group row">
				        	 &emsp;&emsp;
                                                   <div class="card" style="width: 18rem;">
                                                    <img class="card-img-top" src="images/developer.png" alt="Card image cap">
                                                    <div class="card-body">
                                                      <h5 class="card-title">Admin</h5>
                                                      <p class="card-text"> Add/Remove Employee and Repair Records.</p>
					         ...
					         <div class="card" style="width: 18rem;">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <p class="card-text"> View Employee Taks</p>
