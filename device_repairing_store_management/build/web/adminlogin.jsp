...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
	...
	<%
            ...
            ResultSet rs=st.executeQuery("select admin_password from admin_login where admin_name='"+userid+"'"); 
				...
				<div class="all-center">
				        ...
				        <div class="form-group row">
				        	<div class="col-md-4"></div>
				          	<div class="col-md-4">
                                                    <input class="form-control" type="text" placeholder="Admin Login" readonly>
                                                </div>
				        	<div class="col-md-4"></div>
				        </div>
                                        <div class="form-group row">
				        ...
				        <div class="form-group row">
					        ...
					        <div class="col-md-4">
					         <label for="exampleInputPassword1">Password</label><i class="text-danger"> *</i>
                                                 <input type="password" class="form-control" id="pwd" placeholder="Password" required="" name="pwd">
							 </div>
				        	<div class="col-md-4"></div>
				        </div>   
