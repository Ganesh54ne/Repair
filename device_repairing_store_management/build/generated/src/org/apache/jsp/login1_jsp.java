...
public final class login1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                                 <input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\" required=\"\" name=\"pwd\">\n");
      out.write("\t\t\t\t\t\t\t </div>\n");
      out.write("\t\t\t\t        \t<div class=\"col-md-4\"></div>\n");
      out.write("\t\t\t\t        </div>   \n");
      out.write("\t\t\t\t        <div class=\"form-group row\">\n");
      out.write("\t\t\t\t\t        <div class=\"col-md-4\"></div>\n");
      out.write("\t\t\t\t\t        <div class=\"col-md-4\">\n");
      out.write("                                                    <label for=\"selectlogin\">Select User</label>\n");
      out.write("                                                    <select class=\"form-control\" id=\"selectid\" name=\"selectlogin\">\n");
